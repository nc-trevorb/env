...
(defvar bgcolor/default-colors-alist
  '(
    ("white" . "white")
...
(defmacro bgcolor/with-color-variables (&rest body)
  "`let' bind all colors defined in `bgcolor/colors-alist' around BODY.
Also bind `class' to ((class color) (min-colors 89))."
  (declare (indent 0))
  `(let ((class '((class color) (min-colors 89)))
         ,@(mapcar (lambda (cons)
                     (list (intern (car cons)) (cdr cons)))
		   bgcolor/default-colors-alist))
     ,@body))

(bgcolor/with-color-variables
  (custom-theme-set-faces
   'bgcolor

   `(default ((t (:foreground ,white :background ,black))))
   `(linum ((t (:foreground ,lightgray :background ,fullblack))))
   ...
   `(font-lock-builtin-face ((t (:background ,brightblue))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,lightgray))))
   `(font-lock-comment-face ((t (:foreground ,lightgray))))
   `(font-lock-constant-face ((t (:background ,magenta))))
   `(font-lock-function-name-face ((t (:background ,red))))
   `(font-lock-keyword-face ((t (:background ,blue))))
   `(font-lock-negation-char-face ((t (:background ,red))))
   `(font-lock-string-face ((t (:background ,yellow))))
   `(font-lock-type-face ((t (:background ,green))))
   `(font-lock-variable-name-face ((t (:background ,magenta))))
